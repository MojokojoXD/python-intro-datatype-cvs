...
print('A') if score >= 90 else print('B') if score >= 80 and score <= 89 else print('C') if score >= 70 and score <= 79 else print('D') if score >= 60 and score <= 69 else print('F');
